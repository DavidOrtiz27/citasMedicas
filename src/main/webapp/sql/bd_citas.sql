...
INSERT INTO citas (fecha, hora, paciente_id, doctor_id, estado) VALUES
-- Citas para hoy
(CURDATE(), '09:00', 1, 1, 'CONFIRMADA'),
(CURDATE(), '10:00', 2, 2, 'CONFIRMADA'),
(CURDATE(), '11:00', 3, 3, 'CONFIRMADA'),
(CURDATE(), '15:00', 4, 4, 'PENDIENTE'),
(CURDATE(), '16:00', 5, 5, 'CONFIRMADA'),
(CURDATE(), '17:00', 6, 6, 'PENDIENTE'),

-- Citas para mañana
(DATE_ADD(CURDATE(), INTERVAL 1 DAY), '09:00', 7, 7, 'CONFIRMADA'),
(DATE_ADD(CURDATE(), INTERVAL 1 DAY), '10:00', 8, 8, 'CONFIRMADA'),
(DATE_ADD(CURDATE(), INTERVAL 1 DAY), '11:00', 1, 1, 'PENDIENTE'),
(DATE_ADD(CURDATE(), INTERVAL 1 DAY), '15:00', 2, 2, 'CONFIRMADA'),
(DATE_ADD(CURDATE(), INTERVAL 1 DAY), '16:00', 3, 3, 'PENDIENTE'),
(DATE_ADD(CURDATE(), INTERVAL 1 DAY), '17:00', 4, 4, 'CONFIRMADA'),

-- Citas para pasado mañana
(DATE_ADD(CURDATE(), INTERVAL 2 DAY), '09:00', 5, 5, 'CONFIRMADA'),
(DATE_ADD(CURDATE(), INTERVAL 2 DAY), '10:00', 6, 6, 'PENDIENTE'),
(DATE_ADD(CURDATE(), INTERVAL 2 DAY), '11:00', 7, 7, 'CONFIRMADA'),
(DATE_ADD(CURDATE(), INTERVAL 2 DAY), '15:00', 8, 8, 'PENDIENTE'),
(DATE_ADD(CURDATE(), INTERVAL 2 DAY), '16:00', 1, 1, 'CONFIRMADA'),
(DATE_ADD(CURDATE(), INTERVAL 2 DAY), '17:00', 2, 2, 'CONFIRMADA'); 