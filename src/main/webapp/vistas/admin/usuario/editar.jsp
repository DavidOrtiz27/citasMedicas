...
<html lang="es">
<head>
    <title>Editar Usuario - Sistema de Citas Médicas</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="${pageContext.request.contextPath}/admin/usuario/editar/${usuario.id}" method="post" class="needs-validation" novalidate>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <small class="text-muted">Deje este campo en blanco si no desea cambiar la contraseña</small>
                                </div>
                            </div>
